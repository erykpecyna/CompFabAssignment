...
int main(int argc, char** argv) {
	...
	if (argc > 1) {
		...
		model_file = std::string(PROJECT_SOURCE_DIR) + "/data/assignment1/" + argv[1] + ".stl";
		gcode_file_brute_force = std::string(PROJECT_SOURCE_DIR) + "/data/assignment1/results/" + argv[1] + "_brute_force.gcode";
		gcode_file = std::string(PROJECT_SOURCE_DIR) + "/data/assignment1/results/" + argv[1] + ".gcode";
	}
